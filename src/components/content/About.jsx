...
const About = () => {
    return (<section id="about">
        ...
        <ul>
            ...
            <li>SAP(UI5, HANA, IoT), AWS(S3, Cloudfront, Route53, EC2, Lambda, API Gateway, Cloudwatch, Jenkins), GCP(Firestore, DataStore)</li>
        </ul>
        <p>Currently I'm exploring ErLang and deepfakes in my free time</p>
</section>)
}
